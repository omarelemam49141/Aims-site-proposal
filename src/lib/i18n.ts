    ...
    sections: {
      executiveSummary: {
        ...
        bullets: [
          ...
          "تجربة ثنائية اللغة: العربية والإنجليزية مع دعم RTL الصحيح، وتنسيق مناسب للطباعة/تصدير PDF.",
      ...
      options: {
        ...
        optionA: {
          ...
          includes: [
            ...
            "دعم ثنائي اللغة (English + Arabic RTL) وتصميم جاهز للطباعة/PDF.",
          ],
          goodFor:
        ...
        packages: [
          {
            ...
            durationPlaceholder: "المدة: [مثلاً 14 يوم]",
            details: [
          ...
          },
          {
            ...
            durationPlaceholder: "المدة: [مثلاً 1–2 جلسة]",
            details: [
          ...
          },
          {
            ...
            durationPlaceholder: "المدة: [مثلاً 3 أشهر]",
            details: [
      ...
      nextSteps: {
        ...
        detailsTitle: "للبدء بسرعة نحتاج:",
        details: [
